...
Rounded species properties are suitable for teaching arithmetic only. Declared compositions are complete and do not represent a real gas supply. Normal-volume properties use the explicit ideal normal state stated in the methods. The synthetic thermal allocation is fixed and compatible; no private design envelope is exposed.
